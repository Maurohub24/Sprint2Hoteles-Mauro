import imageBambaAreco from "./images/la-bamba-de-areco.jpg";
import imageSainte from "./images/sainte-jeanne.jpg";
import imageEntreCielos from "./images/entre-cielos.jpg";
import imageHuacalera from "./images/huacalera.jpg";
import imageMerced from "./images/merced-del-alto.jpg";
import imageAzulReal from "./images/azur-real.jpg";
import imageRinconSocorro from "./images/rincon-del-socorro.jpg";
import imageLunaCasa from "./images/luma-casa-de-montana.jpg";
import imageCasaTurquesa from "./images/casa-turquesa.jpg";
import imageVilaSanta from "./images/vila-da-santa.jpg";
import imageUxua from "./images/uxua-casa.jpg";
import imageDosGanchos from "./images/ponta-dos-ganchos.jpg";
import imageAtacama from "./images/alto-atacama.jpg";
import imagePatagonia from "./images/tierra-patagonia.jpg";
import imageVira from "./images/vira-vira.jpg";
import imageVik from "./images/vik-chile.jpg";
import imageHigueras from "./images/casa-higueras.jpg";
import imageTinto from "./images/campo-tinto.jpg";
...
console.log(today, "today", firsttoday);
const hotelsData = [
  {
    slug: "la-bamba-de-areco",
    name: "La Bamba de Areco",
    photo: imageBambaAreco,
    description:
